...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hi {{ $user->name }},</p>
            <p>Thank you for registering with <strong>BioVue</strong>. Your OTP code is:</p>
            <div class="otp-box">{{ $otp }}</div>
            <p>This OTP will expire in <strong>5 minutes</strong>. Please enter it in the app to verify your email address.</p>
            <p>If you did not request this, please ignore this email.</p>
            <p>Thanks,<br><strong>BioVue</strong></p>
        </div>
        <div class="footer">
            &copy; {{ date('Y') }}BioVue. All rights reserved.
        </div>
    </div>
</body>
</html>
